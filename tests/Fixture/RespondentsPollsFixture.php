...
/**
 * RespondentsPollsFixture
 *
 */
class RespondentsPollsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'poll_fk' => ['type' => 'index', 'columns' => ['poll_id'], 'length' => []],
            'respondent_fk' => ['type' => 'index', 'columns' => ['respondent_id'], 'length' => []],
        ],
        '_constraints' => [
