 ...
 * Answers Model
 *
 * @property \App\Model\Table\RespondentsPollsTable|\Cake\ORM\Association\BelongsTo $RespondentsPolls
...
class AnswersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('RespondentsPolls', [
            'foreignKey' => 'respondents_polls_id',
            'joinType' => 'INNER'
        ]);
    ...
    {
        $rules->add($rules->existsIn(['respondents_polls_id'], 'RespondentsPolls'));
