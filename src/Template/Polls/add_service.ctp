    ...
    <div class="form-group">
        ...
        <select id="services" name="service" required class="form-control">
            ...
            <?php foreach ($services as $service): ?>
                <?php echo "<option value='$service->id' area='$service->area_id'>$service->name</option>"; ?>
            <?php endforeach; ?>
        </select>
        <small id="emailHelp" class="form-text text-muted">Este servicio pertenece al area de: <p id="service"></p></small>
