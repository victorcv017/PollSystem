...
class AnswersController extends AppController
{
    ...
    public function view($id = null)
    {
        $answer = $this->Answers->get($id, [
            'contain' => ['RespondentsPolls', 'Questions']
        ]);
    ...
    public function add()
    {
        ...
        $respondentsPolls = $this->Answers->RespondentsPolls->find('list', ['limit' => 200]);
        $this->set(compact('answer', 'respondentsPolls'));
    }
